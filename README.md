...
**Infra**: Docker, Kubernetes, AWS (S3, EC2, IAM), CI/CD  
**AI**: OpenAI API, RAG, embeddings, vector DBs

---

### Highlights

- Delivered a \$50K custom project ahead of schedule with zero critical bugs
- Optimized MongoDB aggregation pipelines reducing query time by ~40%
- Built multi-tenant SaaS backend serving 500+ concurrent users
- Mentored 4 developers on Node.js and scalable backend patterns

---

[Portfolio](https://naimbiswas.vercel.app/) Â· [LinkedIn](https://linkedin.com/in/naim-biswas) Â· nayeembiswas2@gmail.com
